...
export const translations = {
  fr: {
    ...
    hero: {
      ...
      subtitle:
        'Chaînes, pendentifs et bracelets choisis pièce par pièce, livrés à votre porte dans les 58 wilayas.',
  ...
  ar: {
    ...
    hero: {
      ...
      subtitle:
        'سلاسل وقلادات وأساور مُنتقاة قطعة بقطعة، تصل إلى باب منزلك في الولايات الـ58.',
      cta: 'اكتشفي المجموعة',
    },
    trust: {
      delivery: 'التوصيل إلى الولايات الـ58',
