...
- **Product page** (`/product/:id`) — up to 5 photos, and an order form: first name, last name, phone number, and all 58 Algerian wilayas. Size selector appears only if the admin enabled sizes for that product.
